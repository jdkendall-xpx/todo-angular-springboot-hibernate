...
public class ModifyTodoValidator {
    ...
    public TodoEntryChanges validate(String idString, TodoEntry todoChanges) throws ModifyTodoValidatorException {
        ...
        Optional<String> lastModifiedAt = Optional.ofNullable(todoChanges.getLastModifiedAt());


        return new TodoEntryChanges(id, maybeTitle, maybeDesc, maybeDateCreated, maybeDueOn,maybeCompletedOn,lastModifiedAt,maybeCompleted);
    }
    ...
    private void validateLastModifiedAtIsISOFormat(TodoEntry todoChanges) throws ModifyTodoValidatorException {
