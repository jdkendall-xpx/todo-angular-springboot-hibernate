...
public class TodoEntryChanges {
    ...
    public TodoEntryChanges(long id, Optional<String> title, Optional<String> description, Optional<String> dateCreated,Optional<String> dueOn,Optional<String> completedOn, Optional<Boolean> completed) {
        this.id = id;
        this.title = title;
