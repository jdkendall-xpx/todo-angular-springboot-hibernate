...
public class TodoEntryChanges {
    ...
    public TodoEntryChanges(Long id, Optional<String> title, Optional<String> description, Optional<String> dateCreated, Optional<Boolean> completed,Optional<String> dueOn, Optional<String> completedOn,Optional<String> lastModifiedAt) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.createdAt = dateCreated;
